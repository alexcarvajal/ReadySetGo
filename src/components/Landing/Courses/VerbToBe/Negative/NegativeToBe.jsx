...
const NegativeToBe = ({darkMode, toggleDarkMode, title, showButton}) => {
  return (
    <>
    <Header darkMode={darkMode} toggleDarkMode={toggleDarkMode} showButton={true}  title="Negative To Be" />
